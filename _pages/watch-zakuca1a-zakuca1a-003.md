...
Sve veličine su preuzete iz dostavljene log datoteke `watch-zakuca1a-zakuca1a-003.log`.
...
<div class="wide-graph">
    <iframe src="{{ site.baseurl }}/watch-htmls-a/watch-zakuca1a-zakuca1a-003.html" width="100%" height="800px" frameborder="0"></iframe>
</div>
