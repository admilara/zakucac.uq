...
Sve veličine su preuzete iz dostavljene log datoteke `watch-zakuca1a-zakuca1a-083.log`.
...
Prikazane veličine su:
    ...
    - VHINC - Nalog za povećanje reference U na VN (binarni signal)
    - VHDEC - Nalog za smanjenje reference U na VN (binarni signal)
    - QHENABLE - Uključena regulacija Q na sučelju (binarni signal)

<div class="wide-graph">
    <iframe src="{{ site.baseurl }}/watch-htmls-a/Watch_ZAKUCA1A-ZAKUCA1A_083.html" width="100%" height="800px" frameborder="0"></iframe>
</div>
