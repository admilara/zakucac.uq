...
Sve veličine su preuzete iz dostavljene log datoteke `watch-zakuca1a-zakuca1a-067.log`.
...
Prikazane veličine su:
    ...
    - QHINC - Nalog za povećanje reference Q na VN (binarni signal)
    - QHDEC - Nalog za snižavanje reference Q na VN (binarni signal)
    - VHCTRON - Uključena regulacija U na sučelju (binarni signal)

<div class="wide-graph">
    <iframe src="{{ site.baseurl }}/watch-htmls-a/Watch_ZAKUCA1A-ZAKUCA1A_067.html" width="100%" height="800px" frameborder="0"></iframe>
</div>
